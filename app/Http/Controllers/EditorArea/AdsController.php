...
class AdsController extends Controller
{
    ...
    {
        $ads = Ads::all();
        return view('editorArea.ads.index', compact('ads'));
    }

    public function table(Request $request)
    {
        $config = new \stdClass();
        $config->routeName = 'EditorArea.ads';
        $config->table = 'ads';
        ...
        $results = datatables($query)
            ...
            ->editColumn('status', function ($request) use ($config) {
                return view('editorArea.ads.status')->with(
                    [
    ...
    {
        return view('editorArea.ads.single');
    }
    ...
    public function store(AdsRequest $request)
    {
        ...
        if (Ads::create($data)) {
            ...
            return redirect()->route('EditorArea.ads.index');
        }
    ...
    {
        $ad = Ads::find($id);
        return view('editorArea.ads.single', compact('ad'));
    }
