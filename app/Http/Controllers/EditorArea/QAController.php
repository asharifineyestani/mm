...
class QAController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('EditorArea.questions.index',compact('questions'));
    }
    ...
    {
        return view('EditorArea.QA.single');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($question){
            ...
            return redirect()->route('EditorArea.QA.index');
        }
    ...
    public function edit($id)
    {
        ...
        return view('EditorArea.QA.single',compact('question'));
    }
