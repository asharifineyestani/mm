...
class RequestController extends Controller
{
    public function index(){
        return view('editorArea.requests.index');
    }
    ...
    public function getRequests(Request $request)
    {
        ...
        $results = datatables($query)
            ...
            ->addColumn('operation', function ($request){
                return view('editorArea.requests.partials._operation', [
                    'request_id' => $request->id,
                    'tracking_code' => $request->tracking_code,
                ]);
            })
            ->addColumn('program_status', function ($request){
                return view('editorArea.partials._program_status', [
                    'p_status' => $request->p_status,
                    'request_id' => $request->id
                ]);
            })
            ->addColumn('checkbox', function ($request){
                return view('editorArea.partials._input_check_box', [
                    'request_id' => $request->id
                ]);
            })
    ...
    public function show($id)
    {
        ...
        $addable=Addable::where('addable_id',$id)
            ->get();
        return view('editorArea.requests.show', [
            'request' => $request,
            'addable' => $addable,
