...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.users.index', compact('roles', 'cities', 'countries'));
    }
    ...
    public function getUsers(Request $request)
    {
        ...
        $results = datatables($query)
            ...
            ->addColumn('operation', function ($request) {
                return view('admin.users.partials._operation', [
                    'user_id' => $request->id
                ]);
            })
            ->addColumn('operation', function ($request) {
    ...
    public function create()
    {
        ...
        $cities = City::all();
        $countries = Country::all();
        return view('admin.users.create', compact('roles', 'cities', 'countries'));
    }
    ...
    public function edit($id)
    {
        ...
        $cities = City::all();
        $countries = Country::all();
        return view('admin.users.edit', compact('user', 'roles', 'cities', 'countries','Url'));
    }
