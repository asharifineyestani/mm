...
class DiscountController extends Controller
{
    ...
    public function getDiscounts(Request $request)
    {
        ...
        $results = datatables($query)
            ->addColumn('operation', function ($discount) {
                return view('admin.discounts.partials.operation', [
    ...
    public function create()
    {
        ...
        return view('admin.discounts.create')->with(['coaches' => $coaches]);
    }
    public function store(Request $request)
    {
        ...
        return redirect('admin/discounts')->with('message', 'کد تخفیف انتخابی با موفقیت ثبت گردید.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($update) {
            Session::flash('alert-info', 'success,' . __('mm.popup.update.success', ['name' => __('mm.discount_code')]));
        }
